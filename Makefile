...
# TOP_FILE := testbench/ref_top.v
TOP_FILE         := pushing_pixels.sv

# List internal component/block files here (separate the filenames with spaces)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
COMPONENT_FILES  := color_converter.sv counter.sv edge_detector.sv mandelbrot.sv new_z.sv shift_register.sv spi_in.sv sync.sv 

# Specify the filepath of the test bench you want to use (ie. tb_top_level.sv)
# (do not include the source folder in the name)
TB               :=  testbench/tb_render_mandel.v
